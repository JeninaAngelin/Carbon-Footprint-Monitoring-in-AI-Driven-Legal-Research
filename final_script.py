...
def find_similar_cases(input_embedding, case_embeddings, file_names, top_k=5):
    ...
    if len(case_embeddings.shape) == 3:
        case_embeddings = case_embeddings.mean(axis=1)  # Average pooling over the last dimension
...
def visualize_case_graph(G, filename="case_graph.png"):
...
if __name__ == "__main__":
    ...
    visualize_case_graph(case_graph, filename="case_graph.png")
